		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProjectAccess().getConstraintsAssignment_9_2(), "rule__Project__ConstraintsAssignment_9_2");
					put(grammarAccess.getProjectAccess().getActivitiesAssignment_10(), "rule__Project__ActivitiesAssignment_10");
