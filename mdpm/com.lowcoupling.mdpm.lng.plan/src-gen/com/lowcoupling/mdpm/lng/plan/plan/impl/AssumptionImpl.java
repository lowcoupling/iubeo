 ...
 * <ul>
 *   <li>{@link com.lowcoupling.mdpm.lng.plan.plan.impl.AssumptionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssumptionImpl extends MinimalEObjectImpl.Container implements Assumption
{
  ...
  {
    return PlanPackage.Literals.ASSUMPTION;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlanPackage.ASSUMPTION__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PlanPackage.ASSUMPTION__VALUE:
        return getValue();
    }
