 ...
 *   <li>{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getEnd <em>End</em>}</li>
 *   <li>{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getDuration <em>Duration</em>}</li>
 *   <li>{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getCompleteness <em>Completeness</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity()
 * @model
 * @generated
 */
public interface Activity extends ActivityElement
{
   ...
   * The list contents are of type {@link com.lowcoupling.mdpm.lng.plan.plan.ResourceInvolvement}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_InvolvedResources()
   ...
   * @see #setStart(String)
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_Start()
   * @model
   * @generated
   */
  String getStart();
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getStart <em>Start</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_After()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getAfter <em>After</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOffset(int)
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_Offset()
   * @model
   * @generated
   */
  int getOffset();
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getOffset <em>Offset</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setEnd(String)
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_End()
   * @model
   * @generated
   */
  String getEnd();
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getEnd <em>End</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setDuration(int)
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_Duration()
   * @model
   * @generated
   */
  int getDuration();
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getDuration <em>Duration</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivity_Completeness()
   * @model
   * @generated
   */
  int getCompleteness();
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.Activity#getCompleteness <em>Completeness</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
