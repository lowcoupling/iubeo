 ...
 * </p>
 *
 * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivityElement()
 * @model
 * @generated
 */
public interface ActivityElement extends EObject
{
   ...
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivityElement_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.ActivityElement#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivityElement_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.lowcoupling.mdpm.lng.plan.plan.ActivityElement#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.lowcoupling.mdpm.lng.plan.plan.PlanPackage#getActivityElement_Dependencies()
   * @model
   * @generated
   */
